...
<#
Example..
GetSPLAExchCALS-Ex2010-v3.4.ps1 -DestinationEmailPrefix SPLAReceiver -DestinationEmailDomain MSP.COM -SourceDomain CLIENTDOMAIN.com -MailContactPrefix MSPSPLAReporting
